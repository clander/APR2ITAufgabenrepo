...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("***** K5.Bruch 1 ******");
        Bruch bruch = new Bruch();
        bruch.zaehler = 24;
        bruch.nenner = 0;
        bruch.ausgeben();

        System.out.println("***** K5.Bruch 2 ******");
        ...
        System.out.println("***** K5.Bruch 4 - Multiplikation ******");
        Bruch bruch4 = new Bruch();
        bruch4.zaehler = 5;
        bruch4.nenner = 6;
        System.out.println("K5.Bruch 4 vor Multiplikation:");
        bruch4.ausgeben();
        Bruch bruch5 = new Bruch();
        bruch5.zaehler = 3;
        bruch5.nenner = 4;
        System.out.println("K5.Bruch 5 vor Multiplikation:");
        bruch5.ausgeben();
        bruch5.multiplizieren(bruch4);
        System.out.println("K5.Bruch 4 nach Multiplikation:");
        bruch4.ausgeben();
        System.out.println("K5.Bruch 5 nach Multiplikation:");
        bruch5.ausgeben();
